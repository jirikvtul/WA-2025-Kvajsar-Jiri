    ...
    <header class="py-5 bg-light border-bottom mb-4">
        <div class="container">
            <div class="text-center my-5">
                ...
                <p class="lead mb-0">Kde a jak nakupovat nové a použité komponenty?</p>
            </div>
        </div>
    </header>
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
                <div class="card mb-4">
                    <div class="card-body">
                        <h2 class="card-title">Nové komponenty</h2>
                        <p class="card-text">Nákup nových komponentů je v České republice jednoduchý díky ověřeným prodejcům jako Alza.cz, Smarty.cz, Datart.cz, Mironet.cz a Sunnysoft.cz. Osobně mám s těmito prodejci dobrou zkušenost. Alza a Smarty nabízejí i použité nebo rozbalené zboží, ale primárně se zaměřují na nové komponenty. Nabízejí také službu sestavení PC za poplatek 999 Kč.</p>
                        <p class="card-text">Pro úsporu doporučuji nakupovat od jednoho prodejce, ale pokud chcete ušetřit, prozkoumejte srovnávače jako Heureka.cz. Hledejte slevy, dopravu zdarma nebo prodlouženou záruku. Tímto způsobem lze ušetřit několik stovek korun, i když ne tisíce.</p>
                        <h3 class="card-title h4">Použité komponenty</h3>
                        <p class="card-text">Použité komponenty nabízejí skvělý poměr cena/výkon. I několik let starý hardware zvládne nové hry na nižší detaily, zejména díky rostoucí oblibě 2K a 4K monitorů. Hlavní portály pro nákup jsou Bazoš.cz, Aukro.cz a Facebook Marketplace.</p>
                        <p class="card-text">Bazoš a Facebook Marketplace fungují jako tržiště bez prostředníka, takže je třeba být opatrný – vyhněte se podvodníkům, neposílejte peníze předem, preferujte osobní předání nebo dobírku. Požadujte fotky, benchmarky nebo důkaz funkčnosti.</p>
                        <p class="card-text">Aukro.cz funguje jako prostředník s větší bezpečností (podobně jako eBay), nabízí záruky vrácení peněz a prodej přes aukce. Ceny jsou zde vyšší, ale bezpečnější. Alza na Aukru prodává i nefunkční nebo použité zboží, které může být výhodné, pokud umíte opravit např. ohnuté piny nebo přepastování grafické karty.</p>
                    </div>
                </div>
                <div class="card mb-4">
                    <img class="card-img-top" src="https://dummyimage.com/850x350/dee2e6/6c757d.jpg" alt="Ilustrační obrázek nákupu komponent">
                    <div class="card-body">
                        <p class="card-text"><em>Obrázek: Ilustrační fotografie nákupu PC komponent, zdroj: Unsplash.com.</em></p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
