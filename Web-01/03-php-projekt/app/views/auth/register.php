                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="../../controllers/register.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                <label for="surname" class="form-label">Příjmení(nepovinný):</label>
                            ...
                            <div class="mb-3">
                                <label for="passwordcheck" class="form-label">Potvrzení hesla: <span class="text-danger">*</span></label>
                                <input type="text" id="passwordcheck" name="passwordcheck" class="form-control"  required>
                            </div>
